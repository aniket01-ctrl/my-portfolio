...
import spaceImg from './assets/img2.jpg';
import tesseract from './assets/img.jpg';
...
const material = new THREE.MeshStandardMaterial({ color: 0x00fffb });
...
const texture = textureLoader.load(tesseract);
